...
cloud-itonami-isic-0128 is steered by the [cloud-itonami](https://itonami.cloud)
...
- **Crop-category/Jurisdiction facts**: open for PR contribution with test coverage
...
- Crop categories and jurisdictions can be extended without breaking Governor logic
- Semantic versioning reflects backward compatibility of the Governor interface

## Dispute Resolution

Disagreements about spice/aromatic/drug-and-pharmaceutical-crop farm-
operations compliance/regulatory constraints or the Governor's decision-
making should be escalated as a formal ADR proposal.
